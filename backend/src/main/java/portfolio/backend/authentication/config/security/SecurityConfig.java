...
import portfolio.backend.authentication.oauth.exception.RestAuthenticationEntryPoint;
import portfolio.backend.authentication.oauth.filter.TokenAuthenticationFilter;
import portfolio.backend.authentication.oauth.handler.OAuth2AuthenticationFailureHandler;
import portfolio.backend.authentication.oauth.handler.OAuth2AuthenticationSuccessHandler;
import portfolio.backend.authentication.oauth.handler.TokenAccessDeniedHandler;
import portfolio.backend.authentication.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository;
import portfolio.backend.authentication.oauth.service.CustomOAuth2UserService;
import portfolio.backend.authentication.oauth.service.CustomUserDetailsService;
